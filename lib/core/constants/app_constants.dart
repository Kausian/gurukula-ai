/// App-wide string constants and branding.
class AppStrings {
  AppStrings._();

  /// Full application name (used on stores / window title).
  static const String appName = 'Gurukula AI';

  /// Short in-app brand shown in the UI.
